...
(() => {
    // Create a small, never-async wrapper around loadBZip2WASM which
    // checks for callers incorrectly using it with `new`.
    var real_loadBZip2WASM = loadBZip2WASM;
    loadBZip2WASM = function (arg) {
        if (new.target) throw new Error('loadBZip2WASM() should not be called with `new loadBZip2WASM()`');
        return real_loadBZip2WASM(arg);
    };
})();
